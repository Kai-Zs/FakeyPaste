...
const releases = [
  {
    ...
    tag: 'v2.0',
    type: 'feat',
    title: '全新双模式架构：简要/高级模式切换，UI 全面升级，快捷键重构',
    changes: [
      '新增简要/高级双模式：标题栏分段滑动开关一键切换，简要模式仅 3 个操作按钮',
      '自定义延时开始按钮：按钮文字实时显示配置的延时值（「N秒后开始」）',
      '迷你模式全面适配：迷你窗口自动跟随工具栏模式，简要迷你最小宽度 330px',
      '模式切换自动缩放窗口：简要 600×500，高级 800×700',
      'Ctrl+Shift+P 快捷键在简要模式下等同于「N秒后开始」按钮，一键完成清空+粘贴+输入',
      '输入过程中快捷键自动忽略，防止误操作',
      'HotkeyHandler 清理死代码，回调从 3 参数简化为 2 参数',
      '新增 constants.py 统一管理颜色、尺寸、快捷键等常量',
      'FontManager 方法统一命名，TypingEngine 添加状态常量',
      '按钮尺寸比例重调，配置区修复空框架高度异常，帮助说明精简约 60%',
      '新增 Vite+Vue3 使用说明网页与更新历史页面（Phycat Vampire 玻璃拟态风格）',
    ],
  },
  {
    version: 'v1.2.1',
